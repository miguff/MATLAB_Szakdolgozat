function [dydt]=UAVDerivatives(y,wpFollowerObj,LookAheadDist,model,e,PHeadingAngle,airSpeed,rollAngleLimit)
...
RollAngle=HeadingControl(y,desiredHeading,e,PHeadingAngle,rollAngleLimit);
