classdef UAVstatespace < nav.StateSpace & ...
    ...
    methods
        function obj = UAVstatespace(varargin)
            ...
            obj@nav.StateSpace(name, numStateVariables, UAVstatespace.DefaultRandomStateBounds);
            ...
            if nargin ~= 0
                [mxRoll,arspeed,flightpathangle,bounds]=UAVstatespace.parseStateSpaceConstuctor(varargin{:});
    ...
    methods (Static, Access = protected)
        function [mxRoll,arspeed,flightpathangle,bnds] = parseStateSpaceConstuctor(varargin)
            ...
            p = matlabshared.autonomous.core.internal.NameValueParser({'MaxRollAngle', 'AirSpeed','FlightPathAngleLimit','Bounds'},...
                {UAVstatespace.DefaultMaxRollAngle, UAVstatespace.DefaultAirSpeed,UAVstatespace.DefaultFlightPathAngleLimit,UAVstatespace.DefaultRandomStateBounds});
            if nargin == 0
                p.parse(varargin{:});
            else
