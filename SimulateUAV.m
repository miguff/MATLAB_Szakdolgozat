function [xENU,yENU,zENU] = SimulateUAV(waypoints,airSpeed,Tend)
...
% Simulate model
simOut = ode45(@(t,y)UAVDerivatives(y,wpFollowerObj,lookAheadDist,model,e,PHeadingAngle,airSpeed,UAVRollLimit), linspace(0,Tend,1000),y0);
xENU=simOut.y(1,:);
yENU=simOut.y(2,:);
zENU=simOut.y(3,:);
